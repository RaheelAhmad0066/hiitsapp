...
import '../../models/custom_time_modal.dart';
...
class CustomWorkOutTickerScreen extends StatefulWidget {
  final List<String> texts;

  CustomWorkOutTickerScreen({this.texts = const ['3', '2', '1']});

  @override
  _CustomWorkOutTickerScreen createState() => _CustomWorkOutTickerScreen();
}

class _CustomWorkOutTickerScreen extends State<CustomWorkOutTickerScreen>
  ...
  Widget build(BuildContext context) {
    timerObj =
        ModalRoute.of(context)?.settings.arguments as CustomWorkoutModal?;
    return Scaffold(
        body: Container(
