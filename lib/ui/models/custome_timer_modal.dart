...
class CustomeTimerModal {
  ...
  factory CustomeTimerModal.fromJson(String source) =>
      CustomeTimerModal.fromMap(json.decode(source));

  factory CustomeTimerModal.fromMap(Map<String, dynamic> map) {
    return CustomeTimerModal(
