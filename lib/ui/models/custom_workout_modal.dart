...
class CustomWorkoutModal {
  ...
  factory CustomWorkoutModal.fromJson(String source) =>
      CustomWorkoutModal.fromMap(json.decode(source));

  factory CustomWorkoutModal.fromMap(Map<String, dynamic> map) {
    return CustomWorkoutModal(
